...
QT_MOC_LITERAL(1, 12, 14), // "newEventLogged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "event"
QT_MOC_LITERAL(4, 34, 9), // "timestamp"
QT_MOC_LITERAL(5, 44, 11) // "onTimerTick"

    },
    "EventLogger\0newEventLogged\0\0event\0"
    "timestamp\0onTimerTick"
};
...
void EventLogger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->newEventLogged((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QDateTime(*)>(_a[2]))); break;
        ...
        {
            using _t = void (EventLogger::*)(const QString & , const QDateTime & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventLogger::newEventLogged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void EventLogger::newEventLogged(const QString & _t1, const QDateTime & _t2)
{
