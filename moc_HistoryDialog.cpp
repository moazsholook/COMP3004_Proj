...
QT_MOC_LITERAL(3, 24, 5), // "event"
QT_MOC_LITERAL(4, 30, 9), // "timestamp"
QT_MOC_LITERAL(5, 40, 12) // "clearHistory"

    },
    "HistoryDialog\0addEvent\0\0event\0timestamp\0"
    "clearHistory"
};
...
void HistoryDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->addEvent((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QDateTime(*)>(_a[2]))); break;
